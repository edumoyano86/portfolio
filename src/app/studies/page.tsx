                ...
                <div className="space-y-12">
                    {studies.map((study, index) => (
                        <div key={index} className="relative flex items-start md:grid md:grid-cols-2 md:gap-8">
                            ...
                            {/* Icon */}
                            <div className="relative z-10 flex items-center justify-center w-8 h-8 bg-background border-2 border-primary rounded-full shrink-0 md:order-1 md:col-start-2 md:translate-x-[-50%]">
                                <study.icon className="w-4 h-4 text-primary" />
                            </div>

                            {/* Card */}
                            <div className={index % 2 === 0 ? 'pl-12 md:pl-0 md:pr-8 md:col-start-1 md:text-right' : 'pl-12 md:pl-8 md:col-start-2 text-left'}>
                                <Card className="shadow-lg hover:shadow-xl hover:shadow-primary/20 hover:border-primary/50 transition-all duration-300 text-left bg-card/50 border-border/50">
                                    <CardHeader>
                                        ...
                                        <div className={`flex items-center text-sm text-muted-foreground pt-2 ${index % 2 === 0 ? 'md:justify-end' : 'justify-start'}`}>
